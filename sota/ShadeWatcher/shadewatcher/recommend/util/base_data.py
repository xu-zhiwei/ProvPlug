...
class DataBase(object):
    ...
    def __init__(self, args) -> None:
        ...
        self.kg_file = self.path + '/train2id-0.9-plugin1.txt'
        ...
        self.n_inter = 0
        self.inter_train_data, self.inter_dict = self._load_ratings([self.path + '/inter2id_be_80_0.9.txt'])
        inter_val_data, _ = self._load_ratings([self.path + '/inter2id_be_20.txt'])
        inter_test_data, _ = self._load_ratings([self.path + '/inter2id_me.txt'])
        ...
        self.n_train_inter = len(self.inter_train_data)
    ...
    def _load_ratings(self, inter_file_list) -> tuple:
        ...
        for inter_file in inter_file_list:            
            f = open(inter_file, 'r')
            lines = f.readlines()
            for l in lines:
                tmp = l.strip()
