...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--eval_threat', default=False, action='store_true',
                        help='evaluate precision/recall/f1 on labeled threat interactions')
    parser.add_argument('--threat_file', type=str, default='',
                        help='path to labeled threat interaction file (each line: e_id threat_e_id label)')
